...
@Component({
  selector: 'app-pdf-viewer-enreg',
  standalone: false,
  templateUrl: './pdf-viewer-enreg.component.html',
  styleUrl: './pdf-viewer-enreg.component.scss',
})
export class PdfViewerEnregComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PdfViewerEnregComponent>,
  ...
  download() {
    this.beService.downloadPdfEnreg(
      this.data.pdfBlob,
